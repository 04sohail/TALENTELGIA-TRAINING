...
// Function to display profile modal with user data

function showProfile() {
  const user = JSON.parse(sessionStorage.getItem("loggedInSuperAdmin"));
  console.log(user);
  if (!user) {
  ...
  document.getElementById("profileAddress").textContent =
    ...
    ", " +
    user.address.pincode;
  document.getElementById("profileCompName").textContent =
    user.company.companyname;
  document.getElementById("profileRole").textContent = user.company.role;
  document.getElementById("profileCompWeb").textContent =
    user.company.companywebsite;
}
