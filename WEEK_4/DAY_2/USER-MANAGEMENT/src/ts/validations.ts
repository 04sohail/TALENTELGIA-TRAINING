...
// ADD FORM//
const addFrom = document.getElementById("addForm") as HTMLFormElement
// LOGIN WARNING & REQUIRED //

// ADD WARNING & REQUIRED //
const addFnameWarning = document.querySelector(".add-fname-warning") as HTMLElement;
const addLnameWarning = document.querySelector(".add-lname-warning") as HTMLElement;
const addEmailWarning = document.querySelector(".add-email-warning") as HTMLElement;
const addPhoneWarning = document.querySelector(".add-phone-warning") as HTMLElement;
const addHNumberWarning = document.querySelector(".add-HNumber-warning") as HTMLElement;
const addStreetWarning = document.querySelector(".add-street-warning") as HTMLElement;
const addCityWarning = document.querySelector(".add-city-warning") as HTMLElement;
const addPinCodeWarning = document.querySelector(".add-pin-code-warning") as HTMLElement;
const addCompanyNameWarning = document.querySelector(
  ".add-company-name-warning"
) as HTMLElement;
const addCompanyWebWarning = document.querySelector(".add-company-web-warning") as HTMLElement;
const addPasswordWarning = document.querySelector(".add-password-warning") as HTMLElement;
const addConfirmPasswordWarning = document.querySelector(
  ".add-confirm-password-warning"
) as HTMLElement;
// EDIT WARNING & REQUIRED //
const editFnameWarning = document.querySelector(".edit-fname-warning") as HTMLElement;
const editLnameWarning = document.querySelector(".edit-lname-warning") as HTMLElement;
const editEmailWarning = document.querySelector(".edit-email-warning") as HTMLElement;
const editPhoneWarning = document.querySelector(".edit-phone-warning") as HTMLElement;
const editHNumberWarning = document.querySelector(".edit-HNumber-warning") as HTMLElement;
const editStreetWarning = document.querySelector(".edit-street-warning") as HTMLElement;
const editCityWarning = document.querySelector(".edit-city-warning") as HTMLElement;
const editPinCodeWarning = document.querySelector(".edit-pin-code-warning") as HTMLElement;
...
const editPasswordWarning = document.querySelector(".edit-password-warning") as HTMLElement;
...
const onBlurValidate = (event: Event, warning: HTMLElement): void => {
...
addFName.addEventListener("blur", (event) =>
  onBlurValidate(event, addFnameWarning)
);
editFName.addEventListener("blur", (event) =>
  onBlurValidate(event, editFnameWarning)
);
addLName.addEventListener("blur", (event) =>
  onBlurValidate(event, addLnameWarning)
);
editLName.addEventListener("blur", (event) =>
  onBlurValidate(event, editLnameWarning)
);
addEmail.addEventListener("blur", (event) =>
  onBlurValidate(event, addEmailWarning)
);
editEmail.addEventListener("blur", (event) =>
  onBlurValidate(event, editEmailWarning)
);

addPhone.addEventListener("blur", (event) =>
  onBlurValidate(event, addPhoneWarning)
);
editPhone.addEventListener("blur", (event) =>
  onBlurValidate(event, editPhoneWarning)
);
addHNumber.addEventListener("blur", (event) =>
  onBlurValidate(event, addHNumberWarning)
);
editHNumber.addEventListener("blur", (event) =>
  onBlurValidate(event, editHNumberWarning)
);

addStreet.addEventListener("blur", (event) =>
  onBlurValidate(event, addStreetWarning)
);
editStreet.addEventListener("blur", (event) =>
  onBlurValidate(event, editStreetWarning)
);

addCity.addEventListener("blur", (event) =>
  onBlurValidate(event, addCityWarning)
);
editCity.addEventListener("blur", (event) =>
  onBlurValidate(event, editCityWarning)
);

addPincode.addEventListener("blur", (event) =>
  onBlurValidate(event, addPinCodeWarning)
);
editPinCode.addEventListener("blur", (event) =>
  onBlurValidate(event, editPinCodeWarning)
);

addCompName.addEventListener("blur", (event) =>
  onBlurValidate(event, addCompanyNameWarning)
);
editCompName.addEventListener("blur", (event) =>
  onBlurValidate(event, editCompanyNameWarning)
);

addCompWeb.addEventListener("blur", (event) =>
  onBlurValidate(event, addCompanyWebWarning)
);
editCompWeb.addEventListener("blur", (event) =>
  onBlurValidate(event, editCompanyWebWarning)
);

addPassword.addEventListener("blur", (event) =>
  onBlurValidate(event, addPasswordWarning)
);

addConfirmPassword.addEventListener("blur", (event) =>
  onBlurValidate(event, addConfirmPasswordWarning)
);
...
function validateField(field:HTMLInputElement, warning:HTMLElement, regex:RegExp) {
