...
const customerCompanyWebsite = document.querySelector(".customer-company-website");
const user = sessionStorage.getItem("loggedInCustomer") ? JSON.parse(sessionStorage.getItem("loggedInCustomer")) : null;
console.log(user);
if (!user) {
